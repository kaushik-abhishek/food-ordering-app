        ...
        <ul className="hidden lg:flex p-4 m-4">
          ...
          <li className="px-4 font-medium text-lg hover:text-orange-400">
            <Link to="/cart" className="">
              <span className="_3yZyp flex items-center ">
                <svg
                  className="_1GTCc _2MSid mr-2"
                  viewBox="-1 0 37 32"
                  height="20"
                  width="20"
                  fill="white"
          ...
          <button
            className="login px-4 font-medium text-lg hover:text-orange-400 flex items-center "
            onClick={() => {
              btnName === "Sign In"
                ? setBtnName("Sign Out")
                : setBtnName("Sign In");
